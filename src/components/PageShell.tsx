    ...
    <main className="min-h-screen bg-[#09090B] text-white">
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute top-12 right-10 h-72 w-72 rounded-full bg-emerald-500/9 blur-3xl" />
          <div className="absolute bottom-[-140px] left-1/2 -translate-x-1/2 h-80 w-[56rem] rounded-full bg-[#FACC15]/9 blur-3xl" />
        </div>
