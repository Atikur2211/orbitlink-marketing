      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10 md:pt-20">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 shadow-[0_0_0_1px_rgba(255,255,255,0.03)]">
          ...
          <span className="text-sm tracking-wide text-white/65">
            Province-Wide Commercial Landing Page
          </span>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-[1.25fr_0.75fr]">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/72 md:text-lg">
              ...
              warehouses, clinics, logistics environments, and commercial
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.25)]">
            ...
            <h2 className="mt-3 text-xl font-semibold tracking-tight">
              Structured delivery for Ontario business environments
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-white/70">
              Built for organizations that want more than a generic ISP
              experience. Orbitlink emphasizes serviceability review, clear
              commercial coordination, documented acceptance, and premium support
              posture.
            </p>

            <div className="mt-6 grid grid-cols-1 gap-3">
              {[
                "Availability confirmed per building",
                "Commercial and industrial fit",
                "Managed LAN and Wi-Fi support",
                "Continuity and failover options",
              ].map((item) => (
                <div
                  key={item}
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-3 space-y-4 leading-relaxed text-white/70">
                <p>
                  Ontario contains some of Canada’s most competitive commercial
                  internet markets, from dense office corridors to industrial
                  parks, warehouse clusters, and mixed-use business environments.
                  Business fibre internet in this market is not just about raw
                  speed. It is about stable operations, clean activation, the
                  right service model, and a support posture that fits business
                  workflows.
                </p>

                <p>
                  Building infrastructure, last-mile feasibility, and
                  serviceability can vary significantly from one location to
                  another. Orbitlink confirms feasibility per address and scopes
                  constraints before activation, rather than making blanket
                  availability claims across an entire city or region.
                </p>

                <p>
                  For many organizations, the right answer is not only fibre
                  access. It may also include managed LAN and Wi-Fi, continuity
                  architecture, static IP needs, voice support, or a clear upgrade
                  path into Dedicated Internet Access when operations become more
                ...
                <p>
                  ...
                  VoIP, VPNs, cameras, internal operational systems, guest Wi-Fi,
                  collaboration tools, booking or payment systems, logistics
                  software, and internal segmented networks. That makes access
                  design, stability, and onboarding posture more important than a
                  simple speed claim.
                </p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">
                    ...
                    static IP needs, managed LAN/Wi-Fi, and continuity
                    requirements.
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/70">
                  Start with an availability request. If your site is multi-user,
                  office-heavy, industrial, or uptime-sensitive, include
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-white/70">
            Clear answers for province-wide commercial search intent, with
            availability confirmed per site before activation.
          </p>
