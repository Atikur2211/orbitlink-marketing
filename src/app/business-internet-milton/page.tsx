...
const PAGE_DESCRIPTION =
  "Business internet in Milton for warehouses, industrial, logistics, and office environments. Fibre, dedicated internet, managed Wi-Fi, and backup connectivity. Check availability by address.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business internet in Milton for industrial, warehouse, logistics, and office environments. Check availability by address and find the right setup for your business.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Business Internet in Milton, ON | Orbitlink",
      },
    ],
  },
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Milton for warehouses, industrial, logistics, and office environments.",
