    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides business internet in Milton for industrial, warehouse, logistics, and
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Milton continues to grow as one of Ontario’s strongest logistics and industrial
                  markets. Business internet in this environment is not just about bandwidth. It is
                  about stable operations, clean activation, the right service model, and support
                  posture that fits warehouse, office, and multi-device environments.
                </p>

                <p>
                  Sites in areas such as the Milton 401 Business Park, Derry Green Corporate
                  Business Park, and other employment corridors may have very different building
                  infrastructure and serviceability. Orbitlink confirms feasibility per address and
                  scopes constraints before activation rather than making blanket availability claims.
                </p>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Milton business internet FAQs</h2>
