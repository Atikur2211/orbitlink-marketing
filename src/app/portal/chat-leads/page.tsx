...
export default async function ChatLeadsPage() {
  ...
  return (
    <PageShell
      eyebrow="PORTAL"
      title="Chat Leads"
      subtitle="Live commercial intake, support follow-up, billing requests, technical cases, appointment requests, and internal sales review for Orbitlink."
    >
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-white/65">
                ...
                manage support cases, track follow-up timing, and route each
                conversation toward the correct commercial or service outcome.
              </p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-sm text-white/72">
              Structured for sales, billing, technical support, and appointment
              handling.
            </div>
          </div>
        </div>
