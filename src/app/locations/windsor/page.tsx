...
const PAGE_PATH = "/locations/windsor";
...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Windsor, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Windsor with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Windsor, ON | Orbitlink™",
    description:
      "Business connectivity in Windsor: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Windsor, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Windsor delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in Windsor?",
  ...
  {
    q: "Is Windsor a good fit for industrial connectivity and business internet?",
    a: "Yes—Windsor has strong industrial and commercial demand where stability, documentation, and support posture matter. We confirm feasibility per site and recommend business fibre or DIA based on operational requirements.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Windsor?",
  ...
  {
    q: "How long does installation take in Windsor?",
...
function jsonLd() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Windsor", item: PAGE_URL },
    ],
  };
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "Windsor" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Windsor",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Windsor, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink delivers operator-grade business connectivity in Windsor with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Windsor connectivity for industrial operations and cross-border business workflows
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Windsor is an industrial market where uptime and clarity matter: operations networks, security systems,
                voice, VPN, and cloud workloads. Orbitlink’s approach is operator-grade—confirm feasibility first, choose
                the correct module (business fibre vs DIA), and deliver with documented acceptance checkpoints.
              </p>

              <p>
                For performance-critical environments, DIA provides a more deterministic posture. For strong value with
                disciplined delivery, business fibre is a strong fit. When internal stability matters, managed LAN/Wi-Fi and
                segmentation posture reduce tickets and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Windsor
              </h3>
          ...
          <aside className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            ...
            <div className="mt-6 text-sm text-white/60">
              Also consider:{" "}
              <Link href="/locations/london" className="text-white/80 hover:text-white underline underline-offset-4">
                London
              </Link>
              {", "}
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Windsor FAQs</h2>
