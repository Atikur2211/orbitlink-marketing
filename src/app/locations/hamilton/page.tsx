// src/app/locations/hamilton/page.tsx
import type { Metadata } from "next";
import Link from "next/link";

const SITE_URL = "https://orbitlink.ca";
const SITE_NAME = "Orbitlink";
const PAGE_PATH = "/locations/hamilton";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in Hamilton with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink Hamilton business internet",
      },
    ],
  },
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Hamilton with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  {
    q: "Do you service my address in Hamilton?",
  ...
  {
    q: "Do you support industrial and manufacturing sites in Hamilton?",
    a: "Yes. Hamilton includes industrial, manufacturing, warehouse, and operations-heavy environments where uptime and service clarity matter. Orbitlink reviews feasibility per site and aligns the right access model to the business need.",
  },
  {
    q: "Do you offer Dedicated Internet Access in Hamilton?",
  ...
  {
    q: "Can you manage LAN and enterprise Wi-Fi across office and operational devices?",
  ...
  {
    q: "How long does installation take in Hamilton?",
...
const buildingTypes = [
  ...
  "Office and mixed-use business sites",
  "Commercial buildings and business parks",
  "Operational environments with continuity requirements",
] as const;
...
function jsonLd() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Hamilton", item: PAGE_URL },
    ],
  };
  ...
  const telecomService = {
    ...
    "@type": "TelecomService",
    "@id": `${PAGE_URL}#service`,
    name: "Business Internet in Hamilton",
    url: PAGE_URL,
    provider: { "@id": ORG_ID },
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="Hamilton business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Hamilton combines broad business demand with strong industrial and operational environments
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Hamilton includes manufacturing, warehousing, logistics, office environments,
                  and operational sites where connectivity quality directly affects uptime,
                  workflow, and service continuity.
                </p>
                ...
                <p>
                  Many Hamilton business environments benefit from a combined posture: business
                  fibre, managed LAN and Wi-Fi, static IP routing where needed, and continuity
                  planning for uptime-sensitive operations.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why Hamilton businesses choose Orbitlink
              </h2>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">Hamilton FAQs</h2>
          <p className="mt-2 text-sm text-white/70 max-w-3xl leading-relaxed">
            Quick answers for buyers evaluating business internet in Hamilton.
          </p>
