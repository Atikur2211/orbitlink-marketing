...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business internet in Markham with fibre, dedicated internet, managed Wi-Fi, voice, and backup connectivity.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
  ...
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Markham with fibre, dedicated internet, managed Wi-Fi, and backup connectivity.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Markham includes dense B2B office corridors and multi-tenant environments where stable connectivity and managed network support matter. Orbitlink reviews each site and matches the right service model to the business need.",
  },
  {
    q: "Do you offer dedicated internet in Markham?",
  ...
  {
    q: "Can you manage my LAN and business Wi-Fi in an office environment?",
...
const whyOrbitlink = [
  ...
  "Backup options for uptime-sensitive teams",
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">Markham business service area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/70 md:text-lg">
                Orbitlink supports Markham businesses with fibre, dedicated internet,
              ...
              <div className="mt-3 text-sm text-white/70">
                Built for B2B offices, professional service firms, clinics, technology businesses, and multi-tenant office environments.
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="CITY" value="Markham business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Markham includes dense B2B office corridors, professional services, clinics,
                  and multi-tenant office environments where connectivity stability and support quality
                ...
                <p>
                  Many Markham offices benefit from a combined setup: business fibre,
                  managed LAN and Wi-Fi, static IP routing where needed, and backup
                  connectivity for uptime-sensitive environments.
                </p>
              </div>
            </div>
