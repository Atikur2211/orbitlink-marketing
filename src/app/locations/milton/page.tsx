// src/app/locations/milton/page.tsx
...
const PAGE_TITLE = "Business Internet & Fibre in Milton, ON | Orbitlink™";
const PAGE_DESCRIPTION =
  "Business internet in Milton with fibre, dedicated internet access, managed LAN and Wi-Fi, continuity options, and address-qualified service review.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in Milton with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink Milton business internet",
      },
    ],
  },
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Milton with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Milton includes major employment and industrial areas where uptime and stability matter. Orbitlink reviews feasibility per site and recommends the right access model based on operational needs.",
  },
  {
    q: "Do you offer Dedicated Internet Access in Milton?",
  ...
  },
  {
    ...
    a: "Yes. Orbitlink frequently reviews warehouse, logistics, and industrial environments in Milton where cloud platforms, cameras, scanners, VPNs, voice systems, and operational applications rely on stable connectivity.",
  },
] as const;
...
const buildingTypes = [
  ...
  "Industrial and employment-area sites",
  "Mixed office and floor-device environments",
  "Commercial buildings and business plazas",
  "Operational sites with continuity requirements",
] as const;

const whyOrbitlink = [
  "Address-qualified availability review",
  "Clear distinction between broadband and DIA",
  "Managed network options for industrial environments",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">Milton Service Area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/70 md:text-lg">
                Orbitlink supports Milton businesses with fibre, dedicated internet, managed
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="Milton business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Milton is a strong industrial and logistics market with uptime-sensitive environments
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Milton continues to grow as a major employment and industrial market with
                  warehousing, logistics, transportation, and mixed office-and-floor environments
                  that depend on stable business connectivity.
                </p>
                ...
                <p>
                  ...
                  and operational platforms. Depending on the site, fibre, DIA, managed
                  LAN and Wi-Fi, or continuity planning may all play an important role.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why Milton businesses choose Orbitlink
              </h2>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">Milton FAQs</h2>
          <p className="mt-2 text-sm text-white/70 max-w-3xl leading-relaxed">
            Quick answers for buyers evaluating business internet in Milton.
          </p>
