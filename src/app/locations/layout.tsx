  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#09090B] text-white">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* keep mobile lighter */}
        <div className="absolute -top-20 left-6 h-52 w-52 rounded-full bg-blue-500/8 blur-3xl sm:h-72 sm:w-72 sm:bg-blue-500/10" />
        <div className="absolute right-6 top-10 h-52 w-52 rounded-full bg-emerald-500/8 blur-3xl sm:h-72 sm:w-72 sm:bg-emerald-500/10" />
        <div className="absolute bottom-[-100px] left-1/2 h-56 w-[32rem] -translate-x-1/2 rounded-full bg-[#FACC15]/8 blur-3xl sm:bottom-[-140px] sm:h-80 sm:w-[56rem] sm:bg-[#FACC15]/10" />
        ...
        {/* subtle side masks only on larger screens */}
