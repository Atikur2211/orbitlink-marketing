...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Barrie, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Barrie with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Barrie, ON | Orbitlink™",
    description:
      "Business connectivity in Barrie: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Barrie, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Barrie delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in Barrie?",
  ...
  {
    q: "Why is Barrie high-ROI for “internet near me” searches?",
    a: "Barrie has strong growth and broad local intent, so many searches are location-based and high intent. Orbitlink focuses on feasibility confirmation and an operator-grade delivery posture rather than overclaiming coverage.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Barrie?",
  ...
  {
    q: "How long does installation take in Barrie?",
...
function jsonLd() {
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "Barrie" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Barrie",
    provider: { "@type": "Organization", name: BUSINESS.name, url: SITE_URL },
    areaServed: { "@type": "City", name: "Barrie" },
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Barrie, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink delivers operator-grade business connectivity in Barrie with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Barrie connectivity for growth markets and high local “near me” intent
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Barrie is a high-growth market where many searches are local and high-intent. Orbitlink’s model is
                operator-grade: confirm feasibility first, align the correct module (business fibre vs DIA), and deliver
                with documented acceptance checkpoints.
              </p>

              <p>
                For sites that depend on uptime—voice, VPN, cameras, and cloud apps—internal stability matters too. Managed
                LAN/Wi-Fi and segmentation posture reduce day-to-day issues and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Barrie
              </h3>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Barrie FAQs</h2>
