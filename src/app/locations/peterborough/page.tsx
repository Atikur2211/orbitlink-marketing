// src/app/locations/peterborough/page.tsx
...
const CITY_NAME = "Peterborough";
const PAGE_TITLE = "Business Internet in Peterborough, ON";
const PAGE_DESCRIPTION =
  "Business internet in Peterborough with fibre, dedicated internet, managed Wi-Fi, static IPs, voice, and backup connectivity. Availability is checked by address.";
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">Peterborough, ON</div>
                </div>
              </div>
            </div>
