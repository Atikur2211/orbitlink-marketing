...
const PAGE_TITLE = "Business Internet & Fibre in North York, Toronto | Orbitlink™";
const PAGE_DESCRIPTION =
  "Business internet in North York with fibre, dedicated internet access, managed LAN and Wi-Fi, continuity options, and address-qualified service review.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in North York with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink North York business internet",
      },
    ],
  },
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in North York with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. North York includes office and multi-tenant environments where stable connectivity and clearer service review matter. Orbitlink aligns the right service path to the business need.",
  },
  {
    q: "Do you offer Dedicated Internet Access in North York?",
...
const buildingTypes = [
  ...
  "Clinic and service-office locations",
  "Business floors with guest and staff Wi-Fi needs",
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">North York Service Area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="North York business locations" />
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  ...
                  connectivity and a more disciplined provider experience matter.
                </p>
                ...
                <p>
                  ...
                  managed network scope, and move into a cleaner onboarding path.
                </p>

                <p>
                  Many North York business environments benefit from a combined posture:
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why North York businesses choose Orbitlink
              </h2>
