...
export const metadata: Metadata = {
  title: "Business Fibre Internet in North York, Toronto | Orbitlink™",
  description:
    "Operator-grade business fibre internet in North York with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in North York, Toronto | Orbitlink™",
    description:
      "Business connectivity in North York: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in North York, Toronto | Orbitlink™",
    description:
      "Operator-grade business connectivity in North York delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in North York?",
  ...
  {
    q: "Do you support multi-tenant offices and professional services in North York?",
    a: "Yes—North York includes dense office clusters and multi-tenant environments where stability and support posture matter. We confirm feasibility per site and align the correct service module for operational needs.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in North York?",
  ...
  {
    q: "Can you manage LAN and enterprise Wi-Fi for office floors?",
  ...
  {
    q: "How long does installation take in North York?",
...
function jsonLd() {
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in North York",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in North York, Toronto
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in North York with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              North York connectivity for dense offices, multi-tenant floors, and high uptime expectations
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                North York is a high-intent office market where stability matters: multi-tenant floors, professional
                services, clinics, and distributed teams that need predictable connectivity and a support posture that
                feels enterprise—not consumer.
              </p>

              <p>
                Orbitlink’s approach is operator-grade: confirm feasibility first, select the correct module (business fibre
                vs DIA), define managed LAN/Wi-Fi posture where needed, and deliver with documented acceptance checkpoints.
              </p>

              <p>
                For offices running voice, VPN, cloud workloads, and guest Wi-Fi, the internal network posture matters as much
                as the access circuit. Managed LAN/Wi-Fi and segmentation posture reduce tickets and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in North York
              </h3>
              ...
              <p>
                ...
                operator-grade support experience that matches office expectations.
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">North York FAQs</h2>
