...
const PAGE_PATH = "/locations/kingston";
...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Kingston, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Kingston with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Kingston, ON | Orbitlink™",
    description:
      "Business connectivity in Kingston: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Kingston, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Kingston delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in Kingston?",
  ...
  {
    q: "Is Kingston a good fit for professional services and operational uptime?",
    a: "Yes—Kingston has strong professional-services and institutional demand where reliable connectivity and clear delivery posture are important. We confirm feasibility per site and recommend business fibre or DIA based on requirements.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Kingston?",
  ...
  {
    q: "How long does installation take in Kingston?",
...
function jsonLd() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Kingston", item: PAGE_URL },
    ],
  };
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "Kingston" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Kingston",
    provider: { "@type": "Organization", name: BUSINESS.name, url: SITE_URL },
    areaServed: { "@type": "City", name: "Kingston" },
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Kingston, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in Kingston with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Kingston connectivity for professional services and operational reliability
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Kingston is a professional-services market where reliability and support posture matter: voice, VPN, cameras,
                cloud apps, and multi-site access. Orbitlink’s approach is operator-grade—confirm feasibility first, select
                the correct module (business fibre vs DIA), and deliver with documented acceptance checkpoints.
              </p>

              <p>
                If your environment is performance-critical, DIA provides a more deterministic posture. Where internal stability
                is a factor, managed LAN/Wi-Fi and segmentation posture reduce tickets and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Kingston
              </h3>
          ...
          <aside className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            ...
            <div className="mt-6 text-sm text-white/60">
              Also consider:{" "}
              <Link href="/locations/ottawa" className="text-white/80 hover:text-white underline underline-offset-4">
                Ottawa
              </Link>
              {", "}
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Kingston FAQs</h2>
