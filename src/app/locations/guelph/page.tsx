...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Guelph, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Guelph with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Guelph, ON | Orbitlink™",
    description:
      "Business connectivity in Guelph: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Guelph, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Guelph delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};
...
const FAQ = [
  ...
  {
    q: "Is Guelph a good fit for business fibre and managed networking?",
    a: "Yes—Guelph has strong SMB and modern office demand where stable access plus managed LAN/Wi-Fi posture improves uptime and reduces day-to-day issues. We confirm feasibility per site.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Guelph?",
...
function jsonLd() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Guelph", item: PAGE_URL },
    ],
  };
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "Guelph" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Guelph",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Guelph, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in Guelph with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Guelph connectivity for SMB offices and modern multi-tenant environments
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Guelph is a strong SMB market where teams depend on cloud services, voice, VPN, and modern Wi-Fi. Orbitlink’s
                posture is operator-grade: confirm feasibility first, align the correct service module, and deliver with
                documented acceptance checkpoints.
              </p>

              <p>
                For sites with performance-critical workloads, we scope DIA. For strong value with disciplined delivery posture,
                business fibre is a strong fit. When internal stability matters, managed LAN/Wi-Fi and segmentation posture
                reduce tickets and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Guelph
              </h3>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Guelph FAQs</h2>
