...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in Guelph with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
  ...
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Guelph with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Guelph includes office, SMB, and modern business environments where stable access and managed network support can improve day-to-day reliability.",
  },
  {
    q: "Do you offer Dedicated Internet Access in Guelph?",
...
const buildingTypes = [
  ...
  "Mixed office and service-business sites",
...
function jsonLd() {
  ...
  const telecomService = {
    ...
    "@type": "TelecomService",
    "@id": `${PAGE_URL}#service`,
    name: "Business Internet in Guelph",
    url: PAGE_URL,
    provider: { "@id": ORG_ID },
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Guelph supports a strong mix of SMB, office, and professional-services demand
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Guelph is a strong business market where many sites rely on cloud
                  services, voice, VPN access, and modern internal networking.
                </p>
                ...
                <p>
                  Many Guelph business environments benefit from a combined posture:
