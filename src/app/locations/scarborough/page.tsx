...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Scarborough, Toronto | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Scarborough with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Scarborough, Toronto | Orbitlink™",
    description:
      "Business connectivity in Scarborough: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Scarborough, Toronto | Orbitlink™",
    description:
      "Operator-grade business connectivity in Scarborough delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes—Scarborough has a strong mix of industrial and commercial corridors. We confirm feasibility per site and recommend broadband fibre or DIA based on operational requirements.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Scarborough?",
  ...
  {
    q: "Can you manage LAN and enterprise Wi-Fi across office + floor devices?",
...
function jsonLd() {
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Scarborough",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Scarborough, Toronto
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in Scarborough with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Scarborough connectivity for industrial corridors and multi-site businesses
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Scarborough is a high-intent market with a strong industrial and commercial base. A stable outcome depends
                on feasibility confirmation, correct service selection (broadband fibre vs DIA), and delivery that’s
                documented end-to-end.
              </p>

              <p>
                Many Scarborough businesses run mixed environments: office teams plus floor devices, cameras, IoT endpoints,
                and voice systems. Orbitlink aligns network posture up front—segmentation, managed LAN/Wi-Fi planning, and
                continuity design when uptime is operationally important.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Scarborough
              </h3>
              ...
              <p>
                Managed LAN/Wi-Fi reduces day-to-day issues: segmentation between office/ops/IoT, stable coverage planning,
                and a support posture aligned with operations—not consumer troubleshooting.
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Scarborough FAQs</h2>
