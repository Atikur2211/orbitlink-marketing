...
const PAGE_PATH = "/locations/london";
...
export const metadata: Metadata = {
  title: "Business Fibre Internet in London, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in London with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in London, ON | Orbitlink™",
    description:
      "Business connectivity in London: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in London, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in London delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in London?",
  ...
  {
    q: "Why is London a good market for “internet near me” business searches?",
    a: "London has broad business density across multiple districts, so many searches are high-intent and location-based. Orbitlink focuses on disciplined onboarding and support posture rather than overclaiming coverage.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in London?",
  ...
  {
    q: "How long does installation take in London?",
...
function jsonLd() {
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "London" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in London",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in London, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in London with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              London connectivity for broad “near me” intent and multi-district business demand
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                London is a high-volume market for location-based searches because businesses are spread across many districts.
                When customers search “business internet near me,” they want clarity: feasibility, delivery posture, and support.
              </p>

              <p>
                Orbitlink’s approach is operator-grade: confirm feasibility first, align the correct service module (business fibre
                vs DIA), and deliver with documented acceptance checkpoints. Where internal stability matters, managed LAN/Wi-Fi and
              ...
              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in London
              </h3>
          ...
          <aside className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            ...
            <div className="mt-6 text-sm text-white/60">
              Also consider:{" "}
              <Link href="/locations/guelph" className="text-white/80 hover:text-white underline underline-offset-4">
                Guelph
              </Link>
              {", "}
              <Link href="/locations/kitchener-waterloo" className="text-white/80 hover:text-white underline underline-offset-4">
                Kitchener-Waterloo
              </Link>
              .
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">London FAQs</h2>
