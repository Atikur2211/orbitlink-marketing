// src/app/locations/london/page.tsx
...
const PAGE_TITLE = "Business Internet & Fibre in London, ON";
const PAGE_DESCRIPTION =
  "Business internet in London with fibre, dedicated internet access, managed LAN and Wi-Fi, continuity options, and address-qualified service review.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${PAGE_TITLE} | Orbitlink`,
    description:
      "Business connectivity in London with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink London business internet",
      },
    ],
  },
  twitter: {
    ...
    title: `${PAGE_TITLE} | Orbitlink`,
    description:
      "Business internet in London with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  ...
  {
    q: "Is London a good fit for business internet and managed networking?",
    a: "Yes. London has broad business demand across office, clinic, service, and multi-location environments where stable connectivity and managed LAN and Wi-Fi can improve day-to-day operations.",
  },
  {
    q: "Do you offer Dedicated Internet Access in London?",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="London business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                London supports broad office, clinic, service, and multi-location business demand
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  London is a broad business market where many buyers begin with location-based
                  intent and need a clearer path from discovery to service qualification.
                </p>
                ...
                <p>
                  Many London business environments benefit from a combined posture:
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why London businesses choose Orbitlink
              </h2>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">London, ON</div>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">London FAQs</h2>
          <p className="mt-2 text-sm text-white/70 max-w-3xl leading-relaxed">
            Quick answers for buyers evaluating business internet in London.
          </p>
