...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business internet in Oakville with fibre, dedicated internet, managed Wi-Fi, voice, and backup connectivity.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
...
const FAQ = [
  ...
  {
    q: "Is Oakville a good fit for business fibre and dedicated internet?",
    a: "Yes. Oakville includes professional services, corporate offices, and multi-tenant business environments where stable connectivity and strong support matter. Orbitlink reviews each site and matches the right service model to the business need.",
  },
  {
    q: "Do you offer dedicated internet in Oakville?",
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">Oakville business service area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="CITY" value="Oakville business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Oakville includes professional services, corporate offices, clinics, and multi-tenant
                  business environments where connectivity quality and support directly affect daily operations.
                </p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">Oakville, ON</div>
                </div>
              </div>
            </div>
