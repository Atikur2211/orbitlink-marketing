...
const PAGE_TITLE = "Business Internet in Richmond Hill, ON";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in Richmond Hill with fibre, dedicated internet, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
  ...
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Richmond Hill with fibre, dedicated internet, managed LAN and Wi-Fi, and structured service review.",
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">Richmond Hill, ON</div>
                </div>
              </div>
            </div>
