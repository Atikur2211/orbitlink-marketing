...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Sudbury, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Sudbury with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Sudbury, ON | Orbitlink™",
    description:
      "Business connectivity in Sudbury: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Sudbury, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Sudbury delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};
...
const FAQ = [
  ...
  {
    q: "Is Sudbury a good fit for regional business internet and uptime?",
    a: "Yes—Sudbury acts as a regional hub where stable connectivity supports operations, professional services, and multi-site workflows. Orbitlink confirms feasibility per site and aligns the right module for your requirements.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Sudbury?",
...
function jsonLd() {
  ...
  const localBusiness = {
    ...
    areaServed: [{ "@type": "City", name: "Greater Sudbury" }, { "@type": "AdministrativeArea", name: "Ontario" }],
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Sudbury",
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Sudbury, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in Sudbury with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Sudbury connectivity for regional operations and multi-site workflows
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Sudbury is a regional hub where businesses often support field teams, multi-location workflows, and operational
                environments that depend on uptime. Orbitlink’s approach is operator-grade: confirm feasibility first, align the
                correct service module (business fibre vs DIA), and deliver with documented acceptance checkpoints.
              </p>

              <p>
                If your site is performance-critical or downtime-sensitive, DIA provides a more deterministic posture. Where internal
                stability matters, managed LAN/Wi-Fi and segmentation posture reduce tickets and prevent instability.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Sudbury
              </h3>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Sudbury FAQs</h2>
