// src/app/locations/sudbury/page.tsx
import type { Metadata } from "next";
import Link from "next/link";

const SITE_URL = "https://orbitlink.ca";
const SITE_NAME = "Orbitlink";
const PAGE_PATH = "/locations/sudbury";
...
const CITY_NAME = "Sudbury";
const PAGE_TITLE = "Business Internet & Fibre in Sudbury, ON";
const PAGE_DESCRIPTION =
  "Business internet in Sudbury with fibre, dedicated internet access, managed LAN and Wi-Fi, continuity options, and address-qualified service review.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${PAGE_TITLE} | Orbitlink`,
    description:
      "Business connectivity in Sudbury with fibre, DIA, managed LAN and Wi-Fi, continuity options, and address-qualified review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink Sudbury business internet",
      },
    ],
  },
  twitter: {
    ...
    title: `${PAGE_TITLE} | Orbitlink`,
    description:
      "Business internet in Sudbury with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  {
    q: "Do you service my address in Sudbury?",
  ...
  {
    q: "Is Sudbury a strong fit for regional business internet and uptime-sensitive operations?",
    a: "Yes. Sudbury acts as a regional business centre where stable connectivity often supports offices, distributed teams, operations environments, and multi-site workflows.",
  },
  {
    q: "Do you offer Dedicated Internet Access in Sudbury?",
  ...
  {
    q: "How long does installation take in Sudbury?",
...
const buildingTypes = [
  "Regional offices",
  "Operational and field-support environments",
  "Professional and service businesses",
  "Commercial multi-tenant sites",
  "Distributed and multi-location teams",
] as const;
...
export default function SudburyLocationPage() {
  return (
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">Sudbury Service Area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/70 md:text-lg">
                Orbitlink supports Sudbury businesses with fibre, dedicated internet,
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="Regional business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Sudbury is a regional operations market where stability matters
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Sudbury acts as a regional business centre where offices,
                  distributed teams, and operational environments often depend on
                  stable connectivity for cloud platforms, voice, VPN, and
                  multi-location workflows.
                </p>

                <p>
                  Orbitlink approaches this market with a simple structure:
                  confirm serviceability, match the site to the right access type,
                  define any managed network scope, and move into a clearer onboarding path.
                </p>

                <p>
                  Many Sudbury environments benefit from a combined posture:
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why Sudbury businesses choose Orbitlink
              </h2>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-3 text-sm text-white/70">
                ...
                <div>
                  ...
                  <div className="text-white/85">Sudbury, ON</div>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">Sudbury FAQs</h2>
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-white/70">
            Quick answers for buyers evaluating business internet in Sudbury.
          </p>
