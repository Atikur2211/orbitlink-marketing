// src/app/locations/ottawa/page.tsx
...
const PAGE_TITLE = "Business Internet in Ottawa, ON | Orbitlink";
const PAGE_DESCRIPTION =
  "Business internet in Ottawa with fibre, dedicated internet, managed Wi-Fi, static IPs, voice, and backup connectivity. Availability is checked by address.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business internet in Ottawa with fibre, dedicated internet, managed Wi-Fi, voice, and backup connectivity.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Orbitlink Ottawa business internet",
      },
    ],
  },
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Ottawa with fibre, dedicated internet, managed Wi-Fi, and backup connectivity.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Ottawa includes office, professional-services, and business environments where stable connectivity and strong support matter. Orbitlink matches the right service path to the business need.",
  },
  {
    q: "Do you offer dedicated internet in Ottawa?",
  ...
  {
    q: "Can you manage LAN and business Wi-Fi for office environments?",
...
const buildingTypes = [
  ...
  "Organizations with compliance-sensitive operations",
  "Multi-site office environments",
  "Business locations with uptime requirements",
] as const;
...
const heroTags = [
  ...
  "Managed Wi-Fi",
  "Backup connectivity",
  "Office and professional-services fit",
] as const;
...
function jsonLd() {
  ...
  const telecomService = {
    ...
    "@type": "Service",
    "@id": `${PAGE_URL}#service`,
    name: "Business Internet in Ottawa",
    url: PAGE_URL,
    provider: { "@id": ORG_ID },
    ...
    <main className="min-h-screen bg-[#0B0F14] text-white">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <div className="mt-3 text-sm text-white/70">
                Built for professional services, office environments, multi-tenant buildings, and business-critical operations.
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="CITY" value="Ottawa business locations" />
          ...
          <div className="space-y-4 lg:col-span-2">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Ottawa combines office, professional-services, and compliance-sensitive business environments
              </h2>

              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  Ottawa includes professional services, office environments, multi-tenant
                  buildings, and organizations where service clarity, stable connectivity,
                  and strong support matter.
                </p>
                ...
                <p>
                  Many Ottawa business environments benefit from a combined setup: business
                  fibre, managed LAN and Wi-Fi, static IP routing where needed, and backup
                  connectivity for uptime-sensitive operations.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <h2 className="mt-3 text-xl font-semibold tracking-tight">
                Why Ottawa businesses choose Orbitlink
              </h2>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">Ottawa FAQs</h2>
          <p className="mt-2 text-sm text-white/70 max-w-3xl leading-relaxed">
            Quick answers for buyers evaluating business internet in Ottawa.
          </p>
