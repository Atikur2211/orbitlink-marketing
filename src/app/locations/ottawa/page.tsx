...
const PAGE_TITLE = "Business Internet & Fibre in Ottawa, ON | Orbitlink™";
const PAGE_DESCRIPTION =
  "Business internet in Ottawa with fibre, dedicated internet access, managed LAN and Wi-Fi, continuity options, and address-qualified service review.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Business connectivity in Ottawa with fibre, DIA, managed LAN and Wi-Fi, continuity, and address-qualified service review.",
    url: PAGE_URL,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_CA",
  ...
  twitter: {
    ...
    title: PAGE_TITLE,
    description:
      "Business internet in Ottawa with fibre, DIA, managed LAN and Wi-Fi, and structured service review.",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Ottawa includes office, professional services, and business environments where stable connectivity and clearer service review matter. Orbitlink aligns the right service path to the operational need.",
  },
  {
    q: "Do you offer Dedicated Internet Access in Ottawa?",
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-12 pt-16 md:pb-16 md:pt-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
            ...
            <span className="text-sm tracking-wide text-white/60">Ottawa Service Area</span>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/70 md:text-lg">
                Orbitlink supports Ottawa businesses with fibre, dedicated internet, managed
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricPill label="MARKET" value="Ottawa business locations" />
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-4 text-white/70 leading-relaxed">
                <p>
                  ...
                  and stronger operational discipline matter.
                </p>
                ...
                <p>
                  Many Ottawa business environments benefit from a combined posture: business
