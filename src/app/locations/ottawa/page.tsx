...
const PAGE_PATH = "/locations/ottawa";
...
export const metadata: Metadata = {
  title: "Business Fibre Internet in Ottawa, ON | Orbitlink™",
  description:
    "Operator-grade business fibre internet in Ottawa with structured onboarding, documented delivery, and enterprise support posture. Check availability.",
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Business Fibre Internet in Ottawa, ON | Orbitlink™",
    description:
      "Business connectivity in Ottawa: fibre, DIA, managed LAN & Wi-Fi, continuity architecture, and voice. Availability by building.",
    url: PAGE_PATH,
    type: "website",
  },
  twitter: {
    ...
    title: "Business Fibre Internet in Ottawa, ON | Orbitlink™",
    description:
      "Operator-grade business connectivity in Ottawa delivered with structured onboarding, documented acceptance, and enterprise support posture.",
  },
};

const FAQ = [
  {
    q: "Do you service my address in Ottawa?",
  ...
  {
    q: "Do you support professional services and multi-tenant office environments?",
    a: "Yes—Ottawa has dense professional services and office environments where stability and support posture matter. We confirm feasibility per site and align the correct service module for your operational needs.",
  },
  {
    q: "Do you offer Dedicated Internet Access (DIA) in Ottawa?",
    a: "Yes—DIA is available for performance-critical environments where deterministic performance and a formal delivery posture are required, subject to feasibility.",
  },
  {
  ...
  {
    q: "How long does installation take in Ottawa?",
...
function jsonLd() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Ottawa", item: PAGE_URL },
    ],
  };
  ...
  const telecomService = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Business Fibre Internet in Ottawa",
...
export default function OttawaLocationPage() {
  return (
    <main className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-10">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-semibold tracking-tight">
          Business Fibre Internet in Ottawa, ON
        </h1>

        <p className="mt-4 max-w-3xl text-base md:text-lg text-white/70 leading-relaxed">
          Orbitlink provides operator-grade business connectivity in Ottawa with a disciplined delivery posture:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            <h2 className="text-xl font-semibold tracking-tight">
              Ottawa connectivity for professional services and compliance-sensitive environments
            </h2>

            <div className="mt-3 space-y-4 text-white/70 leading-relaxed">
              <p>
                Ottawa is a high-trust business market: professional services, regulated and compliance-aware organizations,
                and multi-tenant office environments where stability and delivery posture matter as much as speed.
              </p>

              <p>
                Orbitlink’s approach is operator-grade: confirm feasibility first, align the correct service module
                (broadband fibre vs DIA), define scope for managed LAN/Wi-Fi when needed, and then execute delivery with
                documented acceptance checkpoints.
              </p>

              <p>
                For Ottawa offices running cloud workloads, voice, VPN, or multi-site routing, selecting the correct
                posture up front prevents instability later. Where continuity is required, LTE/5G failover patterns can be
                designed around critical traffic and operational priorities.
              </p>

              <h3 className="pt-2 text-lg font-semibold tracking-tight text-white">
                Service modules commonly deployed in Ottawa
              </h3>
              ...
              <p>
                ...
                the fit when deterministic performance and formal delivery requirements are needed (critical operations,
                compliance-sensitive environments, multi-site routing, or where broadband variance is unacceptable).
              </p>

              <h3 className="pt-4 text-lg font-semibold tracking-tight text-white">Managed network posture</h3>
              <p>
                Managed LAN/Wi-Fi helps Ottawa office environments stay stable: segmentation posture, guest access, coverage
                planning, and a support posture that feels like an operator—not consumer troubleshooting.
              </p>

              <h3 className="pt-4 text-lg font-semibold tracking-tight text-white">Continuity architecture</h3>
              <p>
                If uptime matters, Orbitlink can design LTE/5G continuity patterns aligned to critical services. We scope
          ...
          <aside className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
            ...
            <div className="mt-6 text-sm text-white/60">
              ...
              {", "}
              <Link href="/locations/toronto" className="text-white/80 hover:text-white underline underline-offset-4">
                Toronto
              </Link>
              .
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight">Ottawa FAQs</h2>
